 ...
 */
texture_font_t *font_manager_get_from_filename(
							font_manager_t * self,
							const char * filename,
							const float size,
							const char *language
 ...
 *  @return Requested font
 */
texture_font_t *font_manager_get_from_markup(
							font_manager_t *self,
 ...
 */
char *font_manager_match_description(
					font_manager_t * self,
					const char * family,
					const float size,
					const int bold,
